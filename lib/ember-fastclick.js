/* 
 Modifications copyright (c) 2014 by:

 * Mars @ Substantial, https://github.com/substantial/emberjs-touch

 Original copyright (c) 2012 by:

 * James Hight, https://github.com/JamesHight/emberjs-touch 
				...
				switch(evt.type) {
					...
					case 'touchend':
						if (touch.start) {
							...
							if (moved < 20) {
								// form elements which reveal the [iOS] keyboard should be handled normally
								var shouldDefaultTouch = this.tagName === "INPUT" || this.tagName === "TEXTAREA" || this.tagName === "SELECT";
								if (!shouldDefaultTouch) {
									evt.preventDefault();
